...
public class RapidEjection extends CustomCard {

    public static final String ID = IdHelper.makePath("RapidEjection");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = ImageHelper.getCardImgPath(CardType.ATTACK, "RapidEjection");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(
         ...
         if (this.BlockFluid_demand <= curr_BlockFluid_amount){
           ...
           //add redbull BUFF
              addToTop(new 
              ApplyPowerAction(AbstractDungeon.player,AbstractDungeon.player, new VigorPower(AbstractDungeon.player,this.magicNumber ), this.magicNumber));
