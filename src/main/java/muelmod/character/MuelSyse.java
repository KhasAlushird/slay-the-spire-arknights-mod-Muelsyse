...
// 继承CustomPlayer类
public class MuelSyse extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    ...
    public MuelSyse(String name) {
        ...
        // 如果你的人物没有动画，那么这些不需要写
        // 如果你的人物没有动画，那么这些不需要写
        this.loadAnimation("muelmod/char_model/char_249_mlyss.atlas", "muelmod/char_model/char_249_mlyss.json", 1.8F);
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add("MuelSyseKhas:Mould");
        retVal.add("MuelSyseKhas:CoordinatedAttack");
        return retVal;
    }
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add("MuelSyseKhas:EcoSpecimen");
        return retVal;
    }
    ...
    public static class PlayerColorEnum {
        ...
        // ***并且名称需要一致！***
        @SpireEnum
        public static AbstractCard.CardColor MUEL_COLOR;
    }
    ...
    public static class PlayerLibraryEnum {
        ...
        // 这个变量未被使用（呈现灰色）是正常的
        @SpireEnum
        public static CardLibrary.LibraryType MUEL_COLOR;
    }
}
